...
// const { exec } = await import("child_process"); // reserved for future cloud ingest
...
if (!sourceArg) {
  console.error("يرجى تحديد مسار المصدر الخام، مثال: tsx scripts/ingest-manager.ts raw/books/book.pdf");
  process.exit(1);
}
